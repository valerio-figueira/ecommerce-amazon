...
export function buildApiContainer(env = loadEnv()) {
  ...
  return {
    ...
    useCases: {
      ...
      clearWishlist: new ClearWishlist(wishlistRepository),
      ...
      getComparisonByIdentifier: new GetComparisonByIdentifier(
        comparisonRepository,
        productRepository,
        categoryRepository,
      ),
      listAdminComparisons: new ListAdminComparisons(comparisonRepository),
      getAdminComparison: new GetAdminComparison(
        comparisonRepository,
        productRepository,
        categoryRepository,
      ),
      createCuratedComparison: new CreateCuratedComparison(
        comparisonRepository,
        productRepository,
        webRevalidator,
      ),
      updateComparison: new UpdateComparison(
        comparisonRepository,
        productRepository,
        webRevalidator,
      ),
      publishComparison: new PublishComparison(
        comparisonRepository,
        productRepository,
        webRevalidator,
      ),
      deleteComparison: new DeleteComparison(comparisonRepository, webRevalidator),
      ...
      uploadOperatorAvatar: new UploadOperatorAvatar(
        operatorRepository,
        objectStorage,
        webRevalidator,
      ),
      removeOperatorAvatar: new RemoveOperatorAvatar(
        operatorRepository,
        objectStorage,
        webRevalidator,
      ),
