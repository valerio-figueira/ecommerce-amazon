...
- Subtítulo fixo sugerido: *"Baseado na atividade dos últimos 7 dias"*
...
- [`block-type-meta.ts`](apps/admin/src/components/cms/block-type-meta.ts) → descrição: *"Ranking automático dos últimos 7 dias. Produtos por cliques; artigos por leituras."*
- [`BlockPropsSheet.tsx`](apps/admin/src/components/cms/BlockPropsSheet.tsx) dispatch

**Preview admin:** bloco pode aparecer vazio com meta *"Exibido na vitrine apenas quando houver dados suficientes"* — sem mock de produtos fake.
