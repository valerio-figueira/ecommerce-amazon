...
import { buildCategorySeoDescription, buildCategorySeoTitle } from '@ecommerce-amazon/shared/seo';
          ...
          <div className="flex-1 space-y-6 overflow-y-auto px-6 py-5">
            ...
            <fieldset className="m-0 min-w-0 space-y-4 border-0 border-t border-[var(--admin-gray)] p-0 pt-4">
              ...
              <p className="rounded-lg border border-[var(--admin-gray)] bg-[var(--admin-accent-subtle)] px-4 py-3 text-xs text-[var(--admin-text-muted)]">
                Campos vazios usam templates automáticos na vitrine. Preencha apenas para
                sobrescrever.
              </p>
              ...
              <div className="space-y-2 rounded-lg border border-dashed border-[var(--admin-gray)] px-4 py-3 text-xs text-[var(--admin-text-muted)]">
                <p>
                  <strong className="text-[var(--admin-navy)]">Automático — Title:</strong>{' '}
                  {autoSeoTitle}
                </p>
                <p>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={
                    label.trim() ? autoSeoTitle : 'Deixe vazio para usar o título automático'
                  }
                  maxLength={150}
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Label htmlFor="category-description-html">
                    Conteúdo HTML (rodapé da listagem)
                  </Label>
