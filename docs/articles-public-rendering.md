...
- **Layout:** horizontal desde o mobile — imagem `w-24` (96px) à esquerda, coluna de conteúdo à direita; a partir de `sm` imagem `w-28` (112px), `md:w-32` (128px). CTAs **abaixo** de título/preço/prós-contras na coluna de conteúdo (nunca terceira coluna lateral).
