...
| Redis `AOF fsync taking too long` / SIGTERM                      | Disco VPS lento durante BGSAVE; Swarm substitui task                                                                                               | Stack usa `--no-appendfsync-on-rewrite`; `stop_grace_period: 30s`; monitorar `df -h`                                                                                 |
